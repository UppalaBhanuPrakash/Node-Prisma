...
const config = {
  "generator": {
    ...
    "previewFeatures": [],
    "sourceFilePath": "C:\\Users\\Bhanu Uppala\\Desktop\\my_app\\prisma\\schema1.prisma",
    "isCustomOutput": true
  },
  "relativeEnvPaths": {
    "rootEnvPath": null,
  ...
  "inlineSchema": "// prisma/schema1.prisma\ngenerator client {\n  provider = \"prisma-client-js\"\n  output   = \"../node_modules/@prisma/client1\"\n}\n\ndatasource db {\n  provider = \"postgresql\"\n  url      = env(\"DATABASE_URL_1\")\n}\n\nmodel User {\n  id        Int      @id @default(autoincrement())\n  email     String   @unique\n  name      String?\n  createdAt DateTime @default(now())\n  updatedAt DateTime @updatedAt\n  posts     Post[]\n}\n\nmodel Post {\n  id        Int      @id @default(autoincrement())\n  title     String\n  content   String?\n  published Boolean  @default(false)\n  authorId  Int\n  author    User     @relation(fields: [authorId], references: [id])\n  createdAt DateTime @default(now())\n  updatedAt DateTime @updatedAt\n}\n",
  "inlineSchemaHash": "be2757d045d05c8c035d1a8cb9faf6c46598ca16441d85615aac4a95282c8880",
  "copyEngine": true
}
config.dirname = '/'
